...
texto = Label(text="CRUD PRODUCTOS")
...
agregarBoton = Button()
agregarBoton.config(text="Agregar Producto",font=("Ariel",8,"bold"), command=agregar)
agregarBoton.place(x=40, y=30, width=150, height=30)

mostrarBoton = Button()
mostrarBoton.config(text="Mostrar Productos", font=("Ariel", 8, "bold"), command=Opciones_aparte)
mostrarBoton.place(x=40, y=70, width=150, height =30)

obtenerBoton = Button()
obtenerBoton.config(text="Obtener Producto ", font=("Ariel", 8, "bold"), command=obtener)
obtenerBoton.place(x=40, y=110, width=150, height=30)
